...
export class ToDoFirebaseComponent  {
    ...
    async addItem() {
      ...
      await this.groceryItemsDoc.collection<GroceryItem>('newsletteritems').doc(id).set(groceryItem)
        .then(() => {
    ...
    async deleteItem(groceryItem: GroceryItem) {
      await this.groceryItemsDoc.collection<GroceryItem>('newsletteritems').doc(groceryItem.id).delete()
    ...
    selectItems(uid: string) {
      ...
      this.groceryItems = this.groceryItemsDoc.collection<GroceryItem>('newsletteritems').valueChanges();
